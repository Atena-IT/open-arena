...
class GenericExecutor:
    ...
    """
    def __init__(self, client: LLMClient, model_class: Type[BaseModel], models_list: str, prompt_path: str):
        self.client = client
    ...
    def langfuse_experiment_per_model(self, dataset_name: str, experiment_name: str, experiment_description: str, model_name: str) -> Any:
        """
    ...
    def langfuse_experiment(self, dataset_name: str, experiment_name_prefix: str = "Model Experiment"):
        ...
        for model_name in self.models_list:
            ...
            experiment_description[model_name] = f"Test of model {model_name} on {dataset_name}"
