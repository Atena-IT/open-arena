...
class LangfuseExecutor(Executor[T]):
    ...
    def __init__(
        ...
        self.experiment_name = experiment_name or f"Experiment-{model_config['name']}"
        self.experiment_description = experiment_description or f"Experiment with {model_config['name']}"
